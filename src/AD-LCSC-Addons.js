...
var messages = {
  "zh-CN": {
    "Search": "搜索",
    "Pagination": "分页",
    "Please enter search keyword": "请输入搜索关键字",
    "Response failed: ": "请求失败：",
    ", return code: ": "，返回代码：",
    "Request failed, return code: ": "请求失败，返回代码：",
    "Request failed, please check your network": "请求失败，请检查网络状况",
    "No result": "无结果",
    // 搜索结果表头
    "Title(PartNO)": "标题(零件名称)",
    "Footprint": "封装",
    "Value": "值",
    "Manufacturer": "制造商",
    "SMT": "贴片",
    ...
    "LCSC Part#: ": "立创商城编号：",
    "Advertising": "广告位招租",
    "Request document infomations failed": "请求文档信息失败",
    "Convert document failed": "转换文件失败",
    "A schematic document (*.SchDoc) or pcb document (*.PcbDoc) must be opened":
      "请先打开一个原理图文件 (*.SchDoc) 或 封装库文件 (*.PcbDoc)"
  }
};
